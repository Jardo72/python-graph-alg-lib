...
class AutoIncrement:
    """Simple generator of a sequence of unique numbers. Every value generated by an
    instance of this class is one greater than the previous value generated by
    the same instance of this class.
    """

    def __init__(self, initial_value: int = 1):
        """
        Constructs a new instance of auto increment with the given initial value.

        Args:
            initial_value (int):    Optional initial value (the value 1 is used as
                                    default if this argument is omitted). This
                                    value will be returned by the very first invocation
                                    of the method :method: next_value or :method:
                                    next_value_as_str.
        """
        self._current_value = initial_value

    def next_value(self) -> int:
        """Generates and returns the next sequence value.
    ...
    def next_value_as_str(self) -> str:
        """Generates and returns the next sequence value as string.

        Returns:
            [str]: The generated value converted to string string.
        """
